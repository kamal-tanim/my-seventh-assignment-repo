  ...
  return (
    <div class="mx-2 lg:mx-15 gap-5 flex mt-20 " >
      <div class="bg-gradient-to-r from-[#632EE3] via-[#8249EB] to-[#9F62F2] rounded-xl w-full h-50  ">
        <div class="flex flex-col justify-center items-center   bg-[url(../src/assets/vector1.png),_url(../src/assets/vector2.png)] bg-no-repeat   bg-[auto,_auto] h-full">
      ...
      <div class="bg-gradient-to-r from-[#54CF68] via-[#2AA971] to-[#00827A] rounded-xl w-full h-50  ">
        <div class="flex flex-col justify-center items-center  bg-[url(../src/assets/vector1.png)] bg-no-repeat bg-end h-full">
